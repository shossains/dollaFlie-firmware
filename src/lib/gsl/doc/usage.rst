...
header file, or any other specific type, use its individual filename::
    ...
    #include <gsl_foo.h>               All types
    #include <gsl_foo_double.h>        double        
    #include <gsl_foo_long_double.h>   long double   
    #include <gsl_foo_float.h>         float         
    #include <gsl_foo_long.h>          long          
    #include <gsl_foo_ulong.h>         unsigned long 
    #include <gsl_foo_int.h>           int           
    #include <gsl_foo_uint.h>          unsigned int  
    #include <gsl_foo_short.h>         short         
    #include <gsl_foo_ushort.h>        unsigned short
    #include <gsl_foo_char.h>          char          
    #include <gsl_foo_uchar.h>         unsigned char 
